	...
	<div class="bs">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<a data-toggle="collapse" href="#collapse1"><h3 class="avia">Как покупать авиабилеты онлайн</h3></a>
			</div>
		...
		<div class="panel panel-default">
		<div class="panel-heading">
			<a data-toggle="collapse" href="#collapse2"><h3 class="avia">Как выгодно приобрести билеты</h3></a>
			</div>
		...
		<p class="text-justify avia">
			...
			<ol>
			<li class="avia text-justify"> <b>Покупать билеты от 6 до 2.5 месяцев до предполагаемого вылета.</b> Разные авиакомпании в разное время открывают покупку билетов. Как правило, это делается за период от года до 6 месяцев до вылета. При поиске билетов за год не все авиакомпании могут успеть спланировать свое расписание, обычно это делается в декабре, а хочется рассмотреть все варианты. Поэтому оптимальным временем покупки является от 6 месяцев до 2.5 месяцев до вылета. Статистически доказано, что как только до рейса остается меньше 2.5 месяцев авиабилеты в 99% случаях будут только дорожать. </li>
			<li class="avia text-justify"> <b>Следите за скидками и акциями.</b> Авиакомпании часто устраивают распродажи билетов и делают реальные скидки на билеты, их просто нужно успеть поймать. Все что необходимо делать - регулярно, хотя бы 2 раза в неделю осуществлять поиск по интересующим направлениям.</li>
			<li class="avia text-justify"> <b>Не отправляйтесь в самый пик сезона.</b> Старайтесь обходить пик туристических сезонов, так как на эти даты труднее найти низкие цены. Если все-таки Вы решили поехать в разгар сезона, то постарайтесь не лететь в популярные дни недели: пятницу, субботу и воскресенье. </li>
			<li class="avia text-justify"> На разные даты цены разные, чтобы не менять поисковый запрос несколько раз <b>пользуйтесь специальной формой-календарем</b>. Все что нужно сделать - это выбрать город прилета и вылета. В ячейке соответствующей месяцу будет показана минимальная цена билета на человека в этом месяце. После перехода к одному из них, Вам покажут расписание минимальных цен на выбранный месяц. Выбрав даты вы будете перенаправлены на страницу с предложениями.</li>
			</ol>
		</p>
		...
		<div class="panel panel-default">
		<div class="panel-heading">
		<a data-toggle="collapse" href="#collapse3"><h3 class="avia"> Важно помнить </h3></a>
		</div> 
		...
		<div class="panel panel-default">
		<div class="panel-heading">
		<a data-toggle="collapse" href="#collapse4"><h3 class="avia"> Специальные предложения </h3></a>
		</div> 
